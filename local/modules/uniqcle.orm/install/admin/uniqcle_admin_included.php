...
if (is_dir($_SERVER["DOCUMENT_ROOT"] . "/bitrix/modules/uniqcle.orm/")) {
	...
	require_once($_SERVER["DOCUMENT_ROOT"] . "/bitrix/modules/uniqcle.orm/admin/uniqcle_admin.php");
}
...
if (is_dir($_SERVER["DOCUMENT_ROOT"] . "/local/modules/uniqcle.orm/")) {
	// присоединяем и копируем файл
	require_once($_SERVER["DOCUMENT_ROOT"] . "/local/modules/uniqcle.orm/admin/uniqcle_admin.php");
}
