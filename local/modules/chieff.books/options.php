...
$aTabs = Array(
    array(
        ...
        "TAB"   => Loc::getMessage("CHIEFF_BOOKS_TAB_SETTINGS"), // Название вкладки
        "TITLE" => Loc::getMessage("CHIEFF_BOOKS_TAB_TITLE"),    // Заголовок и всплывающее сообщение вкладки
        // Массив настроек опций для вкладки
        "OPTIONS" => Array(
            Array(
                "field_text", // Имя поля для хранения в бд
                Loc::getMessage("CHIEFF_BOOKS_FIELD_TEXT_TITLE"), // Заголовок поля для вывода
            ...
            Array(
                ...
                Loc::getMessage("CHIEFF_BOOKS_FIELD_LINE_TITLE"), // Заголовок поля для вывода
                "", // Значение по умолчанию (не обязательно получать уже установленное значение для вывода, т.к. метод далее может это делать автоматически)
                Array(
                    "text", // Тип поля
                    10 // Ширина
            ...
            Array(
                ...
                Loc::getMessage("CHIEFF_BOOKS_FIELD_LIST_TITLE"), // Заголовок поля для вывода
                "", // Значение по умолчанию (не обязательно получать уже установленное значение для вывода, т.к. метод далее может это делать автоматически)
                Array(
